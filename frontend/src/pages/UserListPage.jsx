...
const UserListPage = () => {
  ...
  //   } else {
  //     if (!userDetailInfo.name || userDetailInfo._id !== users._id) {
  //       dispatch(getUserDetails(users._id));
  //     } else {
  //       setName(userDetailInfo.name);
  //       setEmail(userDetailInfo.email);
  //       setIsAdmin(userDetailInfo.isAdmin);
  //     }
  //   }
  // }, [
  //   dispatch,
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(updateUser({ _id: userInfo.id, name, email, isAdmin }));
  };
